...
<body>
	...
	<!-- Container for Add Item Form -->
	<div class="container">
		<h2>Add Item</h2>
		<form action="addItem" method="post" onsubmit="return validateForm()">
			<label for="item_code">Item Code:</label><br> <input type="text"
				id="item_code" name="itemCode" required><br> <br>
			<label for="item_name">Item Name:</label><br> <input type="text"
				id="item_name" name="itemName" required><br> <br>
			...
			<br> <label for="price">Price:</label><br> <input
				type="text" id="price" name="price" required><br> <br>
			<label for="description">Description:</label><br>
			<textarea id="description" name="description" rows="8" cols="100"
				required></textarea>
			<br> <br> <input type="submit" value="Add Item">
		</form>
	</div>
