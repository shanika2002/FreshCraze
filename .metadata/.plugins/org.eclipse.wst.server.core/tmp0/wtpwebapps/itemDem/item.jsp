...
<body>
	...
	<div class="small-container">
		...
		<div class="row">
			...
			<div class="col-4">
				<img src="images/koth.jpg">
				<h4>Kothmale Drink</h4>
				<div class="rating">
					<i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
						class="fa fa-star"></i> <i class="fa fa-star"></i> <i
						class="fa fa-star-o"></i>
		...
		<h2 class="title">Food Staples</h2>
		<div class="row">
			<div class="col-4">
				<img src="images/haal.jpg">
				<h4>Rice</h4>
				<div class="rating">
					<i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
						class="fa fa-star"></i> <i class="fa fa-star"></i> <i
		...
		<h2 class="title">Laundry & Household</h2>
		<div class="row">
			<div class="col-4">
		...
		<h2 class="title">Choco & Snacks</h2>
		<div class="row">
			<div class="col-4">
				<img src="images/kand.jpg">
				<h4>Kandos Milk Chocolate</h4>
				<div class="rating">
					<i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
						class="fa fa-star"></i> <i class="fa fa-star"></i> <i
						class="fa fa-star-o"></i>
	...
	<!-- Button to display pending products -->
	<form action="displayItem" method="post">
		<button type="submit">Pending Products...</button>
	</form>
